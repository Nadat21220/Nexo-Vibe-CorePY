...
export function Header({ title }: { title: string }) {
  return (
    <header className="h-[56px] bg-[#050505] border-b border-surface-400 flex items-center justify-between px-6 sticky top-0 z-10">
      <div className="flex items-center">
        <div className="text-surface-600 mr-4">
        ...
        <h2 className="text-sm text-surface-600 uppercase font-semibold tracking-widest">{title}</h2>
      </div>
      ...
      <div className="flex items-center space-x-6">
        <div className="relative">
          ...
          <input 
            ...
            className="bg-surface-300 border border-surface-500 rounded-full py-2 pl-10 pr-4 text-sm text-white focus:outline-none focus:border-primary w-[280px] transition-all placeholder-surface-500 shadow-inner"
          />
        </div>
