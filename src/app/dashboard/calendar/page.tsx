...
export default function CalendarPage() {
  ...
  const fetchData = async (currentRole?: string | null, currentEmail?: string) => {
    ...
    try {
      ...
      if (r === 'empleado' && e) {
        fetchedProyectos = fetchedProyectos.filter((t: any) => t.empleados_asignados && t.empleados_asignados.includes(e));
      } else if (r === 'cliente' && e) {
        fetchedProyectos = fetchedProyectos.filter((t: any) => t.clientes_asignados && t.clientes_asignados.includes(e));
      }
      // Ocultar completados
