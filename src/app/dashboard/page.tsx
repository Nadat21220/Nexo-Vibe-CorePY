...
import { AlertCircle, ArrowUpRight, Target, ChevronRight, Settings, X, Save, Edit2, Trash2, GripVertical } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 bg-surface-200 border border-surface-400 rounded-2xl p-8 flex flex-col shadow-lg">
            <div className="flex items-center mb-6">
              <PieChart className="w-4 h-4 text-primary mr-2" />
                ...
                return (
                  <div key={task.id} className="p-4 bg-surface-300/30 hover:bg-surface-300/50 rounded-xl border border-surface-500 transition-colors flex justify-between items-center group">
                    <div className="flex-1">
                      <div className="flex items-center mb-1">
                        <span className={`text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded mr-3 border ${
                          task.prioridad === 'inmediata' ? 'bg-[#FF0055]/20 text-[#FF0055] border-[#FF0055]/30' :
